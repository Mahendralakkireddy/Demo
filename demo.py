...
def _top_nav():
    ...
    # (Keep the rest of your _top_nav container columns logic unchanged below)
      /* ================================================================
         NAVIGATION
    ...
    <style>
      ...
      /* Logo: exactly above the Welcome section (same 38px left edge). */
      .st-key-dly_main_header .dly-nav-logo-left {
          position: absolute !important;
          left: 38px !important;
          top: 0 !important;
      ...
      /* Home + Document AI: compact, right-aligned, fixed internal gap. */
      .st-key-dly_main_header > div > [data-testid="column"]:last-child {
          display: flex !important;
          justify-content: flex-end !important;
          align-items: center !important;
